class FestivalsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @festival.update(festival_params)
        format.html { redirect_to :back, notice: 'Festival was successfully updated.' }
  ...
  private
    ...
    def festival_params
      params.require(:festival).permit(:name, :start, :end, bookings_attributes: [:stage_name, :start, :end, :artist_id, :festival_id, :id, :_destroy])
    end
end
