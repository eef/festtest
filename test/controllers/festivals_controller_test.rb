...
class FestivalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create festival" do
    assert_difference('Festival.count') do
      post festivals_url, params: { festival: { Festival: @festival.Festival, end: @festival.end, name: @festival.name, start: @festival.start } }
    end
  ...
  test "should update festival" do
    patch festival_url(@festival), params: { festival: { Festival: @festival.Festival, end: @festival.end, name: @festival.name, start: @festival.start } }
